...
-   Remove association between ["functionalism"]{.smallcaps} and ["organicism"]{.smallcaps}
...
::: notes
1.  It is this idea that "society" or "capitalism" are like organisms that have "goals" or "needs" and that the component parts of these abstract macro-entities are like organs.

2.  Functionalism as a way of making arguments first.

    Not as a substantive theory about society!
...
2.  When does ["formal rationality"]{.smallcaps} work and why?
    ...
    ::: auth-reference
    One example of a more *substantive* theory
    :::
:::
...
-   Loose definition of functionalism as a form of argument.

-   One example of what a problem-solving oriented functionalist theory can look like.
...
::: {.fragment style="padding-top: 0.25em;"}
[Purpose]{.smallcaps} means [goal]{.smallcaps} or [function]{.smallcaps}
:::
...
1.  These explanations have a bad reputation. Mysterious. They seem to imply that something in the future can reach back in time and affect the past.

    We cannot infer the origins of some phenomenon by examining its consequences instead of the actual processes that brought it about.

    It also sometimes feels like conspiracy theory.

    So what Stinchcombe did back in the 1960s is...

2.  Feedback or circular causality. A very abstract way of grounding purpose in scientific terms. No problem of backwards causation.

    This is when we start seeing a proliferation of causal diagrams in which "functional" social phenomena resemble the inner-workings of house thermostats and homing torpedos... they are directed towards some kind of built-in goal.

    It avoids talk of "purpose" which is a vague word.

3.  He abandoned this template.
